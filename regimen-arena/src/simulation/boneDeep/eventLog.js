export function createEventLogEntry({
  ...
  activeRegimen,
  activeRegimenBefore = null,
  activeRegimenAfter = null,
  regimenDosingBefore = null,
  regimenDosingAfter = null,
  regimenAction = null,
  hiddenEffects,
  flags,
  pendingConsequences = [],
  ...
  return {
    ...
    activeRegimenBefore: activeRegimenBefore ? [...activeRegimenBefore] : null,
    activeRegimenAfter: activeRegimenAfter ? [...activeRegimenAfter] : [...(activeRegimen ?? [])],
    regimenDosingBefore,
    regimenDosingAfter,
    regimenAction,
